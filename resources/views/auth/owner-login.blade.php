    ...
    <style>
        ...
        * {
        ...
        .ambient-bg {
            position: fixed;
            inset: 0;
            background: radial-gradient(circle at 50% 15%, rgba(192, 142, 92, 0.12) 0%, transparent 60%);
            pointer-events: none;
            z-index: 0;
        }

        /* Card container following 8pt grid & 16px radius */
        .login-card {
        ...
        /* Submit Button following 8pt grid (height 48px) */
        .btn-submit {
            width: 100%;
            height: 48px;
            background: var(--gradient-bronze);
...
<body>
    ...
    <div class="login-card">
        ...
        <p class="portal-subtitle">Akses Otoritas Tertinggi & Manajemen Bisnis</p>
        ...
        <form action="{{ route('owner.login.submit') }}" method="POST">
            ...
            <div class="form-group">
                <label class="form-label" for="email">Email Pemilik</label>
                <div class="input-wrapper">
                    <i class="bi bi-envelope-at input-icon"></i>
                    <input type="email" id="email" name="email" class="form-input" 
                           placeholder="nama@mastercafe.com" required autofocus value="{{ old('email') }}">
                </div>
            </div>
        ...
        <div class="footer-badge">
            ...
            <span>Jalur Khusus Terisolasi & Terenkripsi</span>
        </div>
    </div>
