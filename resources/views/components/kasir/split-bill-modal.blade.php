    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="background-color: #161b22; border: 1px solid #21262d !important; border-radius: 16px;">
            <div class="modal-header border-0 pb-0">
                <h5 class="fw-bold mb-0 text-white">Pisah Tagihan (Pesanan #<span id="split-order-id"></span>)</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" onclick="window.closeModalById('splitModal')" aria-label="Close"></button>
            </div>
            <div class="modal-body p-4 pt-3">
                ...
                <button type="button" class="btn btn-warning w-100 fw-bold rounded-pill" onclick="window.executeSplit()">Proses Pisah Bon</button>
            </div>
        </div>
    </div>
</div>