    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4">
        <div>
            <h2 class="fw-bold mb-1" style="color: #c08e5c;">
                <i class="bi bi-boxes me-2"></i>{{ $promo->exists ? 'Edit Paket Hemat (Bundling)' : 'Buat Paket Hemat / Bundling Menu' }}
            </h2>
            <p class="text-white-50 mb-0">
                Kombinasikan beberapa menu menjadi satu paket combo dengan harga spesial untuk memikat pelanggan Master Cafe.
            </p>
        </div>
        <div>
            ...
            <div class="card border-0 shadow-sm text-white" style="background-color: #161b22; border: 1px solid #21262d !important;">
                <div class="card-header py-3" style="background-color: #0d1117; border-bottom: 1px solid #21262d;">
                    <h5 class="fw-bold mb-0 text-white">
                        <i class="bi bi-sliders me-2" style="color: #c08e5c;"></i>Pengaturan Paket Bundling
                    </h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ $promo->exists ? route('admin.promo.update', $promo->id) : route('admin.promo.store') }}" method="POST" id="promoForm">
                        ...
                        <!-- Hidden fields: Selalu tipe package dan nominal -->
                        <input type="hidden" name="type" value="package">
                        <input type="hidden" name="discount_type" value="nominal">

                        <!-- Judul Paket Promo -->
                        <div class="mb-3">
                            <label class="form-label fw-semibold text-white">
                                Nama Paket Hemat <span class="text-danger">*</span>
                            </label>
                            ...
                            <div class="form-text text-white-50">Nama paket yang akan tampil di kasir dan menu pemesanan pelanggan.</div>
                        </div>

                        <!-- Deskripsi -->
                        <div class="mb-4">
                            <label class="form-label fw-semibold text-white">Deskripsi Paket (Opsional)</label>
                            <textarea name="description" id="inputDesc" rows="2" class="form-control text-white border-secondary bg-dark"
                                      placeholder="Contoh: Beli Kopi Susu Aren + Kentang Goreng lebih hemat Rp 5.000! Cocok untuk teman santai sore.">{{ old('description', $promo->description) }}</textarea>
                        </div>

                        <!-- KOMPOSISI MENU BUNDLING -->
                        <div class="p-3 mb-4 rounded border" style="background-color: #0f131a; border-color: #21262d !important;">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <h6 class="fw-bold mb-0" style="color: #e5b98a;">
                                    <i class="bi bi-bag-check-fill me-2"></i>Komposisi Menu dalam Paket
                                </h6>
                            ...
                            <p class="text-white-50 small mb-3">
                                Tentukan menu-menu apa saja dan porsinya yang termasuk dalam satu paket combo ini.
                            </p>

                            <!-- Daftar Baris Menu Dinamis -->
                            <div id="packageMenuContainer" class="d-flex flex-column gap-2 mb-3">
                                @php
                                    $existingPackageMenus = $promo->exists ? $promo->menus : collect([]);
                                @endphp
                            ...
                            <div class="p-3 rounded mt-3" style="background-color: #161b22; border: 1px dashed rgba(192, 142, 92, 0.4);">
                                <div class="row align-items-center g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <small class="text-white-50" style="font-size: 0.75rem;">(Harga jika konsumen beli satuan terpisah)</small>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label text-white fw-bold mb-1" style="color: #e5b98a !important;">
                                            Harga Paket Bundling (Promo) <span class="text-danger">*</span>
                                        </label>
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="value" id="inputPackageValue"
                                                   ...
                                                   value="{{ old('value', $promo->exists ? ($promo->value + 0) : '') }}"
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <label class="form-label fw-semibold text-white mb-0">
                                    <i class="bi bi-calendar3 me-1 text-warning"></i> Hari Berlaku Paket
                                </label>
                            ...
                            <p class="text-white-50 small mb-2">Kosongkan jika paket berlaku setiap hari tanpa batasan hari.</p>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <label class="form-label text-white small fw-semibold">Tanggal Mulai Berlaku (Opsional)</label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label text-white small fw-semibold">Tanggal Selesai Berlaku (Opsional)</label>
                        ...
                        <div class="form-check form-switch mb-4 p-3 rounded" style="background-color: #0f131a; border: 1px solid #21262d;">
                            ...
                            <label class="form-check-label text-white fw-bold" for="isActiveSwitch" style="cursor: pointer;">
                                Aktifkan Paket Hemat Ini Sekarang
                            </label>
                            <div class="text-white-50 small ms-5">
                                Jika dicentang aktif, paket bundling langsung dapat dipesan oleh kasir dan konsumen.
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 pt-3 border-top border-secondary border-opacity-25">
                            ...
                            <button type="submit" class="btn text-white fw-bold px-4 py-2 shadow-sm" style="background-color: #c08e5c; border-color: #c08e5c;">
                                <i class="bi bi-check2-circle me-2"></i>{{ $promo->exists ? 'Perbarui Paket Hemat' : 'Simpan Paket Hemat' }}
                            </button>
                        </div>
                    </form>
                </div>
                ...
                <div class="card border-0 shadow-sm text-white mb-3" style="background-color: #161b22; border: 1px solid #21262d !important;">
                    <div class="card-header py-3" style="background-color: #0d1117; border-bottom: 1px solid #21262d;">
                        <h6 class="fw-bold mb-0 text-white">
                            <i class="bi bi-eye-fill me-2 text-info"></i>Pratinjau Kartu Paket (Live Preview)
                        </h6>
                    </div>
                    <div class="card-body p-3">
                        <p class="text-white-50 small mb-3">Tampilan kartu paket bundling yang dilihat konsumen & kasir:</p>
                        ...
                        <div class="card border-0 text-white overflow-hidden shadow"
                            ...
                            <div class="p-3">
                                ...
                                <p class="text-white-50 small mb-3" id="previewDesc">Beli Kopi Susu Aren + Kentang Goreng lebih hemat Rp 5.000!</p>

                                <!-- Komposisi Menu Preview -->
                                <div class="p-2 rounded mb-3" style="background-color: rgba(0,0,0,0.25); border: 1px solid #252c38;">
                                    <div class="text-white-50 small fw-semibold mb-2" style="font-size: 0.75rem;">
                                        <i class="bi bi-list-check me-1 text-warning"></i>MENU DALAM PAKET:
                                    </div>
                                    <div id="previewItemList" class="d-flex flex-column gap-1">
                                        <div class="small text-white-50"><i class="bi bi-info-circle me-1"></i> Belum ada menu dipilih</div>
                                    </div>
                                </div>
                ...
                <div class="card border-0 text-white" style="background-color: #161b22; border: 1px solid #21262d !important;">
                    <div class="card-body p-3">
                        <div class="d-flex gap-2">
                            ...
                            <div>
                                <h6 class="fw-bold mb-1 text-white" style="font-size: 0.85rem;">Tips Paket Hemat Kafe:</h6>
                                <p class="text-white-50 small mb-0" style="font-size: 0.75rem;">
                                    Buat paket bundling antara <strong>Minuman Unggulan</strong> (misal Kopi Susu) dan <strong>Camilan / Makanan Ringan</strong>. Pelanggan menyukai diskon bundling paket dan cenderung memesan lebih banyak!
                                </p>
                            </div>
                        </div>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Kalkulator & Update Live Preview
        function updateCalculationsAndPreview() {
            // Update Title & Desc
            previewTitle.textContent = inputTitle.value.trim() || 'Judul Paket Hemat';
