...
<div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col-md-8 mx-auto text-center">
            ...
            <h2 class="fw-bold text-white">Halo, {{ $user->name }}!</h2>
                ...
                <div class="card-header border-bottom-0 p-0" style="background-color: #11151a;">
                    <ul class="nav nav-pills nav-justified" id="pills-tab" role="tablist" style="border-bottom: 1px solid #21262d;">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link d-flex justify-content-center align-items-center active rounded-0 fw-semibold py-3 px-2 px-md-3" id="pills-aktif-tab" data-bs-toggle="pill" data-bs-target="#pills-aktif" type="button" role="tab">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link d-flex justify-content-center align-items-center rounded-0 fw-semibold py-3 px-2 px-md-3 text-secondary" id="pills-riwayat-tab" data-bs-toggle="pill" data-bs-target="#pills-riwayat" type="button" role="tab">
                                <i class="bi bi-clock-history me-2 fs-6"></i>
                                <span class="text-nowrap">Riwayat</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link d-flex justify-content-center align-items-center rounded-0 fw-semibold py-3 px-2 px-md-3 text-secondary" id="pills-profil-tab" data-bs-toggle="pill" data-bs-target="#pills-profil" type="button" role="tab">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="pills-aktif" role="tabpanel">
                            <div class="text-center mb-4">
                                <h5 class="fw-bold text-white mb-1" style="font-size: 1.25rem;">Pesanan Sedang Berlangsung</h5>
                                <p class="text-secondary small mb-0">Pantau progres pesanan makanan dan minuman Anda secara langsung</p>
                            </div>
                        ...
                        <div class="tab-pane fade" id="pills-riwayat" role="tabpanel">
                            <div class="text-center mb-4">
                                <h5 class="fw-bold text-white mb-1" style="font-size: 1.25rem;">Riwayat Pesanan Saya</h5>
                                <p class="text-secondary small mb-0">Daftar seluruh transaksi dan pesanan yang pernah Anda buat</p>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 mx-auto">
                                    <div class="card border-0 shadow-sm rounded-4" style="background-color: #0e1217; border: 1px solid #21262d !important;">
                                        <div class="card-body p-4 p-md-5">
                                            <div class="text-center mb-4">
                                                <h5 class="fw-bold text-white mb-1" style="font-size: 1.25rem;">Informasi Akun</h5>
                                                <p class="text-secondary small mb-0">Perbarui profil dan nomor kontak akun Anda</p>
                                            </div>
