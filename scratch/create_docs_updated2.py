...
docx_path = r'c:\xampp\htdocs\angkringan-pos\docs\Pertanyaan_Wawancara_Master_Cafe_Lengkap.docx'
doc.save(docx_path)
print(f"Created Word Document at {docx_path}")

# 2. Update Excel File
excel_path = r'c:\xampp\htdocs\angkringan-pos\docs\Pertanyaan_Wawancara_Master_Cafe_Lengkap.xlsx'
# Add closing statement as a final row
excel_data = questions.copy()
excel_data.append({
    "No": "",
    "Topik": "Penutup & Latar Belakang Aplikasi",
